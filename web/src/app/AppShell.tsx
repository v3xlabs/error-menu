...
const MENU_ITEM = "flex items-center rounded-control px-2 py-1.5 text-sm text-slate-700 no-underline outline-none select-none data-[highlighted]:bg-raised data-[disabled]:cursor-not-allowed data-[disabled]:opacity-60 dark:text-slate-300";
  ...
  return (
    <div class="flex items-center gap-3">
      ...
      <DropdownMenu placement="bottom-end" gutter={6}>
        <DropdownMenu.Trigger class="flex max-w-48 items-center gap-1.5 rounded-control bg-raised px-3 py-1.5 text-sm font-medium text-slate-700 hover:bg-raised-hover dark:text-slate-300">
