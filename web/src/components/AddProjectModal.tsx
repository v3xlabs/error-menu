          ...
          <Dialog.Content class="w-full max-w-md rounded-lg border border-slate-200 bg-white p-5 shadow-xl dark:border-slate-800 dark:bg-slate-900">
            ...
            <form class="mt-4 space-y-4" onSubmit={event => void handleSubmit(event)}>
              ...
              <div class="flex justify-end gap-2 pt-1">
                ...
                <button type="submit" disabled={isSubmitting()} class="rounded-md bg-slate-900 px-3 py-1.5 text-sm font-medium text-white hover:bg-slate-700 disabled:cursor-not-allowed disabled:opacity-60 dark:bg-slate-100 dark:text-slate-900 dark:hover:bg-white">
